...
export default function ProjectNum() {
  return (
    <div className="container mx-auto px-2 sm:px-4 sm:py-10 text-white">
      <motion.h1
        initial={{ opacity: 0, y: -40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="text-xl sm:text-2xl md:text-4xl lg:text-5xl mb-2 font-extrabold underline underline-offset-8 tracking-tight text-gray-100 "
      >
        Numbers of Project
      </motion.h1>
