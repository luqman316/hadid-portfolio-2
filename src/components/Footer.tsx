function Footer() {
  return (
    // swd: Footer component for the website
    <footer className="w-full text-gray-300 py-8 mt-12 border-t border-gray-700">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-sm text-center md:text-left flex-1">
          &copy; {new Date().getFullYear()}{" "}
          <span className="font-semibold text-indigo-400"></span>. All rights
          reserved.
        </div>
          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M3 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm0 8a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-2zm8-8a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zm0 8a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2zm0 8a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"
              />
            </svg>
            Phone
          </a>
